...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container px-4 md:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground md:text-xl">
              PROVOID übersetzt neurowissenschaftliche Forschung in praktische Lösungen für Unternehmen und Sport: Neuromarketing, Neuroathletik und wissenschaftlich fundierte Strategien.
            </p>
      ...
      {/* Stats Section - Auszeichnungen früh für Autorität (GEO) */}
      <Stats />
      ...
      {/* FAQ Section (GEO: Q&A with FAQPage schema) */}
      <Faq />
